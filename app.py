...
headers = {
    "Authorization" : "Token r8_Xo2C3MFBq2PlbxSC6sQrlBD6eYVyJze1QZn1a", #this is from https://replicate.com/account/api-tokens
...
def index():
    if request.method == "POST":
        ...
        body = json.dumps(
            {
              "version" : "db21e45d3f7023abc2a46ee38a23973f6dce16bb082a930b0c49861f96d1e5bf", #this is the midjourney version
              "input" : {"prompt":q}
            }
        )
